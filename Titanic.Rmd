...
# Linear regression
set.seed(100)
lr <- lrProcedure(age.train, folds=4, rep=10)
```

```{r fig.width=10, fig.height=5}
# Compare MSE
boxplot(nn.3[,3], nn.4[,3], nn.5[,3], nn.6[,3],nn.33[,4], nn.44[,4], nn.55[,4], nn.66[,4], lr[,2], names=c("NN3","NN4","NN5","NN6","NN33","NN44","NN55","NN66", "Linear"), main="MSE by method")
```
